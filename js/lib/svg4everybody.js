...
(this,function(){
    function a(a,b){
        if(b){
            ...
            for(var e=b.cloneNode(!0);
            e.childNodes.length;)c.appendChild(e.firstChild);a.appendChild(c)
        }
    }
    function b(b){
        ...
        {if(4===b.readyState){
            ...
            c.body.innerHTML=b.responseText,b._cachedTarget={}),
            b._embeds.splice(0).map(function(d){var e=b._cachedTarget[d.id];
                    ...
                    if(e&&(!f.validate||f.validate(i,h,g))){
                        ...
                        if(n.length){
                            ...
                            p||(p=j[n]=new XMLHttpRequest,
                                ...
                                b(p)}else a(h,document.getElementById(o))}}else ++c
                            }
                            k(d,67) 
                        }
                        var e,f=Object(c),
